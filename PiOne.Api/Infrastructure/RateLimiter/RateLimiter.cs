...
namespace PiOne.Api.Infrastructure.RateLimiter
{
    public class RateLimiter : IRateLimiter
    {
        ...
        /// <summary>
        /// Create an instance of this class that allows x request over y seconds
        /// T: Khoi tao doi tuong cho phep x request trong vong y giay
        /// </summary>
        ...
        /// <summary>
        /// Check whether we've used up all of allocation
        /// </summary>
        /// <returns>True if we're over the limit, false if we've got some allocation left</returns>
        public bool CheckLimit() { return (rateLimiter.Count >= _qty && rateLimiter.Peek().Add(_duration) > DateTime.UtcNow); }
    }
}
