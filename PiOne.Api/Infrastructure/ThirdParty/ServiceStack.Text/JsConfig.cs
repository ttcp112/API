...
using PiOne.Api.Infrastructure.ThirdParty.ServiceStack.Text.Json;
using PiOne.Api.Infrastructure.ThirdParty.ServiceStack.Text.Jsv;

namespace PiOne.Api.Infrastructure.ThirdParty.ServiceStack.Text
{
    public static class
        JsConfig
    {
        ...
        public static System.Collections.Generic.HashSet<Type> TreatValueAsRefTypes = new System.Collections.Generic.HashSet<Type>();
	    ...
	    public static void Reset()
        {
            ...
            TreatValueAsRefTypes = new System.Collections.Generic.HashSet<Type> { typeof(KeyValuePair<,>) };
